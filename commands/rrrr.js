...
async(Void, citel, text,{ isCreator }) => {
 ...
 cmd({
             pattern: "steal",
             alias:["take", "حقوقي", "سرقه", "سرقة"]
             desc: "Makes sticker of replied image/video.",
             category: "sticker",
             filename: __filename,
         },
         async(Void, citel, text) => {
             if (!citel.quoted) return citel.reply(`*منشن الصوره او الفيديو اللي تبي تسرقه.*`);
